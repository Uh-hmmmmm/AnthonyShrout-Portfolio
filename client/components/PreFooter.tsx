...
const logoOutline = asset("/images/logos/AS_Logo_GreyOUTLINE.svg");

export default function PreFooter() {
  return (
    <WhiteGrainBackground
      id="contact"
      className="flex min-h-[500px] scroll-mt-[63px] flex-col items-center justify-center px-6 py-24 sm:min-h-[600px] md:py-28"
    >
      <img
        src={grainCircle}
        alt=""
      ...
      <img
        ...
        alt=""
        aria-hidden="true"
        className="pointer-events-none absolute left-1/2 top-15 z-[1] h-auto w-[300px] max-w-none -translate-x-1/2 -translate-y-[10%] opacity-[70%] object-contain sm:w-[380px] md:w-[460px] lg:w-[540px]"
      />
